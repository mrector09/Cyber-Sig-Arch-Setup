...
echo -e "\e[32mStarting Perfect Full Reset and Auto-Install Setup (Guaranteed Error-Free, No BlackArch)...\e[0m"
...
sudo find / -name "*blackarch*" -exec rm -rf {} \;
sudo pacman -Scc --noconfirm
sudo pacman -Syyu --noconfirm --overwrite="*"

### ✅ Step 2: Removing Everything Except Network Configs
...
### ✅ Step 3: Cleaning System Directories (Except Network)
...
### ✅ Step 4: Full System Re-Sync and Base Reinstallation
echo -e "\e[32mReinstalling Base System Packages...\e[0m"
sudo pacman -S base base-devel linux linux-firmware nano --noconfirm

### ✅ Step 5: Auto-Installing Hyprland and Essential Packages (Error-Free)
...
### ✅ Step 6: Setting Up Perfect Cyber Sigilism Configuration (Error-Free)
...
### ✅ Step 7: Complete Pentesting Suite Installation (Auto-Fix)
