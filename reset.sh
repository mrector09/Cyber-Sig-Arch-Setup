...
echo -e "\e[32mStarting Full Reset and Clean Install (Hyprland Conflict Fix)...\e[0m"
...
### ✅ Step 1: Removing BlackArch Completely (If Exists)
...
### ✅ Step 2: Removing All Conflicting Hyprland Packages (Hyprlock, Hyprpaper, Hyprutils)
echo -e "\e[32mRemoving Conflicting Hyprland Packages (Hyprlock, Hyprpaper, Hyprutils)...\e[0m"
sudo pacman -Rns hyprlock hyprpaper hyprutils libhyprutils --noconfirm || echo "No Conflicting Packages Found."

### ✅ Step 3: Removing Everything Except Network Configs
...
### ✅ Step 4: Cleaning System Directories (Except Network)
...
### ✅ Step 5: Full System Re-Sync and Base Reinstallation
...
### ✅ Step 6: Installing Hyprland and Essential Packages (Error-Free)
...
### ✅ Step 7: Setting Up Perfect Cyber Sigilism Configuration (Error-Free)
...
### ✅ Step 9: Automatic Reboot into New Hyprland Setup
